...
const Arabe = () => {
  ...
  //       <h1 className="text-white text-4xl font-bold mb-8 text-center">Cours d'Arabe</h1>
  ...
  return (
    <main className="min-h-screen pt-24 px-4 bg-gradient-to-br from-gray-100 via-white to-gray-200">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-gray-900 text-4xl font-bold mb-8 text-center">Cours d'Arabe</h1>
